...
export function ServicesShowcase() {
  return (
    <section className="py-24 md:py-32 bg-[#ECE8E2] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          ...
          <Link
            href="/services"
            className="inline-flex items-center gap-2 font-sans text-[10px] uppercase tracking-widest text-[#111111] hover:text-[#A67C52] transition-colors group mt-6 md:mt-0 font-bold border-b border-[#111111] hover:border-[#A67C52] pb-1"
          >
            All Services
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div
                  className="group relative bg-[#F8F7F4] border border-[#ECE8E2] rounded-lg overflow-hidden flex flex-col h-full hover:shadow-xl transition-all duration-500"
                ...
                >
                  ...
                  <div className="relative aspect-[16/10] overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-[#161616]/20 group-hover:bg-[#161616]/10 transition-colors" />
                  </div>

                  {/* Body Content */}
                  <div className="p-8 flex-grow flex flex-col justify-between">
                    <div>
                      <div className="w-10 h-10 rounded-full bg-[#ECE8E2] flex items-center justify-center text-[#A67C52] mb-6">
                        <Icon className="w-5 h-5" />
                      </div>
                      <h3 className="font-serif text-xl text-[#111111] tracking-wider mb-4">
                        {service.title}
                      </h3>
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-2 font-sans text-[9px] uppercase tracking-widest text-[#A67C52] group-hover:text-[#111111] transition-colors mt-auto font-bold"
                    >
                      Explore Service
