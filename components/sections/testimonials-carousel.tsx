...
const mockTestimonials: Testimonial[] = [
  ...
  },
  {
    ...
    review: "M.A. Interiors designed a state-of-the-art office that reflects our brand's forward-looking philosophy. Excellent spatial planning and premium finishes throughout.",
    rating: 5,
  },
];
    ...
    <section className="py-24 md:py-32 bg-[#ECE8E2] relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
        ...
        <GSAPReveal direction="up" duration={0.8}>
          ...
          <h2 className="font-serif text-3xl sm:text-5xl text-[#111111] tracking-wide mb-16">
            Client Voices
          </h2>
        </GSAPReveal>
        ...
        <div className="relative min-h-[300px] w-full flex flex-col items-center justify-center mb-12">
          ...
          <div className="absolute -top-10 opacity-5 text-[#A67C52]">
            <Quote className="w-20 h-20 fill-[#A67C52]" />
          </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <blockquote className="font-serif text-lg sm:text-xl md:text-2xl text-[#111111] italic leading-relaxed tracking-wide mb-8">
                "{activeTestimonial.review}"
              </blockquote>

              <cite className="not-italic">
                <span className="font-sans text-xs tracking-widest text-[#111111] font-semibold uppercase block mb-1">
        ...
        <div className="flex gap-4">
          <button
            onClick={handlePrev}
            className="p-3 text-[#111111] hover:text-[#A67C52] transition-colors rounded-full border border-[#161616]/10 hover:border-[#A67C52]/40 bg-[#F8F7F4] shadow-sm hover:shadow"
