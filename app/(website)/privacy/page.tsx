...
export const metadata = {
  title: "Privacy Policy | Turk Interiors",
  ...
  return (
    <div className="bg-[#F0F4F8] pt-32 pb-24 md:pt-40 md:pb-32">
      <div className="max-w-3xl mx-auto px-6">
        <h1 className="font-serif text-3xl sm:text-4xl text-[#0B1B3D] mb-8 border-b border-[#E2E8F0] pb-4">
          Privacy Policy
        </h1>
        
        <div className="font-sans text-xs text-[#475569] space-y-6 leading-relaxed">
          <p>
            Effective Date: July 19, 2026
          </p>
          <p>
            At Turk Interiors, we respect your privacy. This policy outlines how we handle the information you submit via our online project brief forms, WhatsApp connections, and newsletter subscriptions.
          </p>
          <h3 className="font-serif text-lg text-[#0B1B3D] mt-8">1. Information Collection</h3>
          <p>
          ...
          <h3 className="font-serif text-lg text-[#0B1B3D] mt-8">2. Use of Information</h3>
          <p>
          ...
          <h3 className="font-serif text-lg text-[#0B1B3D] mt-8">3. Security</h3>
          <p>
