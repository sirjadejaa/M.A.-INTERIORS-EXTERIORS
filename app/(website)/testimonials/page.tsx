...
export const metadata = {
  title: "Client Testimonials & Google Reviews | Turk Interiors",
  description:
...
const testimonials = [
  ...
  },
  {
    ...
    review: "We wanted a home that feels like a resort. Turk Interiors delivered exactly that—a peaceful, warm, clutter-free sanctuary. The custom woodwork in the wardrobes and kitchen is premium.",
    rating: 5,
    location: "Mira Road East",
  },
  {
    ...
    review: "Turk Interiors designed a state-of-the-art office that reflects our brand's forward-looking philosophy. Outstanding spatial planning and lighting indices.",
    rating: 5,
    ...
    <div className="bg-[#F0F4F8] pt-32 pb-24 md:pt-40 md:pb-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="mb-20 text-center">
          ...
          <div className="inline-flex flex-col items-center bg-[#E2E8F0] border border-[#E2E8F0]/60 px-8 py-6 rounded-lg mt-6">
            <span className="font-sans text-[10px] tracking-wider uppercase text-[#475569] mb-2">
              Google Customer Reviews Rating
            </span>
            <div className="flex items-center gap-2 mb-1">
              <span className="font-serif text-3xl font-semibold text-[#0B1B3D]">4.6</span>
              <div className="flex text-[#D4AF37]">
                {Array.from({ length: 5 }).map((_, i) => (
                  <Star
                    key={i}
                    className={`w-5 h-5 ${
                      i < 4 ? "fill-[#D4AF37]" : "fill-transparent text-[#D4AF37]"
                    }`}
                  />
                ))}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {testimonials.map((test, index) => (
            <GSAPReveal
              ...
              duration={0.8}
            >
              <div className="bg-white p-8 md:p-10 rounded-lg border border-[#E2E8F0] shadow-sm flex flex-col justify-between h-full relative overflow-hidden">
                <div className="absolute top-6 right-6 text-[#D4AF37]/5 pointer-events-none">
                  <Quote className="w-12 h-12 fill-[#D4AF37]" />
                </div>
                <div>
                  ...
                  <p className="font-serif text-sm italic text-[#475569] leading-relaxed mb-8">
                    "{test.review}"
                  </p>
                </div>
                <div className="border-t border-[#E2E8F0] pt-4 mt-auto">
                  <h4 className="font-sans text-xs tracking-wider text-[#0B1B3D] font-semibold uppercase">
                    {test.name}
                  </h4>
                  <p className="font-sans text-[9px] tracking-widest text-[#475569] uppercase mt-1">
