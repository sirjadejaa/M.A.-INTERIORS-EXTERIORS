...
export const metadata = {
  title: "Design Atelier Journal | M.A. Interiors & Exteriors",
  description:
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          {activeBlogs.map((blog, idx) => (
            <GSAPReveal
              ...
              duration={0.8}
            >
              <article className="group flex flex-col h-full bg-white border border-[#ECE8E2] rounded-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                <Link href={`/blog/${blog.slug}`} className="flex flex-col h-full">
                  ...
                  <div className="p-8 flex-grow flex flex-col justify-between">
                    <div>
                      ...
                      <h3 className="font-serif text-xl sm:text-2xl text-[#111111] tracking-wide mb-4 leading-snug group-hover:text-[#A67C52] transition-colors">
                        {blog.title}
                      </h3>
                    ...
                    <span className="inline-flex items-center gap-2 font-sans text-[10px] uppercase tracking-widest text-[#A67C52] font-bold group-hover:text-[#111111] transition-colors mt-auto">
                      Read Journal
