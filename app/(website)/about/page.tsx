...
export const metadata = {
  title: "About Our Studio | Turk Interiors",
  description:
    "Discover the story of Turk Interiors and our team of elite design thinkers shaping luxury spaces in Pune, Maharashtra.",
};
...
const timelineSteps = [
  {
    ...
    description: "Established with a commitment to handcrafted woodwork and architectural honesty.",
  },
  {
    year: "2013",
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center mb-28">
          <div className="lg:col-span-6 relative">
            <div className="relative aspect-[4/5] w-full max-w-[450px] overflow-hidden rounded-lg shadow-xl border border-[#E2E8F0] mx-auto">
              <Image
                src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=600"
                alt="Turk Interiors Founder"
                fill
            ...
            <div className="absolute -bottom-6 right-10 bg-[#D4AF37] text-white px-6 py-3 rounded shadow-lg font-serif italic text-sm">
              Turk Interiors Founder
            </div>
          </div>

          <div className="lg:col-span-6">
            <h3 className="font-serif text-2xl sm:text-3xl text-[#0B1B3D] mb-6">
            ...
            <blockquote className="border-l-2 border-[#D4AF37] pl-6 font-serif italic text-lg text-[#0B1B3D] my-8">
        ...
        {/* Core Values grid */}
        <div className="py-20 border-y border-[#E2E8F0] mb-28">
          <h3 className="font-serif text-center text-3xl text-[#0B1B3D] mb-16">
            Atelier Values
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center text-center">
              <div className="w-12 h-12 rounded-full bg-[#E2E8F0] text-[#D4AF37] flex items-center justify-center mb-6">
                <ShieldCheck className="w-6 h-6" />
              </div>
              <h4 className="font-serif text-lg text-[#0B1B3D] mb-3">Honesty in Materials</h4>
              <p className="font-sans text-xs text-[#475569] leading-relaxed max-w-xs">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h4 className="font-serif text-lg text-[#0B1B3D] mb-3">Turnkey Rigor</h4>
              <p className="font-sans text-xs text-[#475569] leading-relaxed max-w-xs">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h4 className="font-serif text-lg text-[#0B1B3D] mb-3">Ergonomic Precision</h4>
              <p className="font-sans text-xs text-[#475569] leading-relaxed max-w-xs">
        ...
        <div>
          ...
          <div className="relative border-l border-[#E2E8F0] ml-4 md:ml-32 pl-8 md:pl-16 py-8 flex flex-col gap-16">
            {timelineSteps.map((step, idx) => (
              <GSAPReveal key={idx} direction="left" delay={idx * 0.1}>
                <div className="relative">
                  {/* Timeline bullet */}
                  <div className="absolute -left-[41px] md:-left-[81px] top-1.5 w-6 h-6 rounded-full bg-[#F0F4F8] border-2 border-[#D4AF37] flex items-center justify-center">
                    <div className="w-2 h-2 rounded-full bg-[#D4AF37]" />
                  </div>
                  <span className="font-serif text-2xl font-light text-[#D4AF37] block mb-2">
                    {step.year}
                  </span>
                  <h4 className="font-serif text-xl text-[#0B1B3D] mb-3">{step.title}</h4>
                  <p className="font-sans text-xs text-[#475569] max-w-xl leading-relaxed">
                    {step.description}
                  </p>
                </div>
              </GSAPReveal>
