...
export const metadata = {
  title: "Terms & Conditions | Turk Interiors",
    ...
    <div className="bg-[#F0F4F8] pt-32 pb-24 md:pt-40 md:pb-32">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="font-sans text-xs text-[#475569] space-y-6 leading-relaxed">
          ...
          <h3 className="font-serif text-lg text-[#0B1B3D] mt-8">1. Project Brief & Consultations</h3>
          <p>
          ...
          <h3 className="font-serif text-lg text-[#0B1B3D] mt-8">2. Warranties</h3>
          <p>
          ...
          <h3 className="font-serif text-lg text-[#0B1B3D] mt-8">3. Copyrights</h3>
          <p>
            All architectural drawings, renders, and site photographs showcased on this website are the intellectual property of Turk Interiors. Reproduction or use without permission is prohibited.
          </p>
        </div>
      </div>
    </div>
