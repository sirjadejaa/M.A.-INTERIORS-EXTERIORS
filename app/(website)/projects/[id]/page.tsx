      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16 items-start">
          ...
          <div className="lg:col-span-4 flex justify-start lg:justify-end mt-4 lg:mt-0">
            <span className="font-sans text-[10px] tracking-widest uppercase text-[#555555] bg-[#ECE8E2] px-4 py-2 border border-[#ECE8E2]/60 rounded-full">
              {project.location}
            </span>
          </div>
        </div>
        ...
        <div className="relative aspect-[21/9] w-full overflow-hidden rounded-lg border border-[#ECE8E2] mb-16 shadow-sm">
          <Image
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-10 border-y border-[#ECE8E2] mb-16">
          <div className="flex items-center gap-3">
            <Compass className="w-5 h-5 text-[#A67C52]" />
            <div>
              <span className="font-sans text-[9px] text-[#ECE8E2]/90 uppercase bg-[#A67C52] px-1.5 py-0.5 rounded-sm block mb-1 w-max">
                Area Dimensions
              </span>
              <span className="font-sans text-xs text-[#111111] font-semibold">{project.area || "4,500 sq ft"}</span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="font-sans text-xs text-[#111111] font-semibold">{project.duration || "6 Months"}</span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <Clipboard className="w-5 h-5 text-[#A67C52]" />
            <div>
              <span className="font-sans text-[9px] text-[#ECE8E2]/90 uppercase bg-[#A67C52] px-1.5 py-0.5 rounded-sm block mb-1 w-max">
                Atelier Client
              </span>
              <span className="font-sans text-xs text-[#111111] font-semibold">{project.client || "Confidential Client"}</span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="font-sans text-xs text-[#111111] font-semibold">{project.location}</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24">
          <div className="lg:col-span-8">
            <h3 className="font-serif text-2xl text-[#111111] mb-6">Project Narrative</h3>
        ...
        <div className="mb-24">
          <h3 className="font-serif text-3xl text-center text-[#111111] mb-12">
        ...
        {project.testimonial && (
          <div className="bg-[#ECE8E2] p-12 rounded-lg border border-[#ECE8E2]/60 text-center flex flex-col items-center max-w-4xl mx-auto">
            <span className="font-sans text-[9px] text-[#A67C52] tracking-widest uppercase mb-4 block">
              Atelier Testimonial
            </span>
            <blockquote className="font-serif italic text-xl sm:text-2xl text-[#111111] leading-relaxed mb-6">
              "{project.testimonial}"
            </blockquote>
            <cite className="not-italic">
              <span className="font-sans text-xs tracking-widest text-[#111111] font-semibold uppercase block">
