  ...
  try {
    const project = await prisma.project.create({
      data: {
        ...
        area: formData.area,
        materials: typeof formData.materials === "string" ? formData.materials : JSON.stringify(formData.materials || []),
  ...
  try {
    const service = await prisma.service.create({
      data: {
        ...
        processSteps: typeof formData.processSteps === "string" ? formData.processSteps : JSON.stringify(formData.processSteps || []),
